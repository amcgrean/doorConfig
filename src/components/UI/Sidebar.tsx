...
import { ChevronRight, Check, Box } from 'lucide-react';
...
export function Sidebar() {
    const { step, selections, selectOption } = useConfiguratorStore();
    ...
    return (
        <aside className="w-96 bg-white border-l border-slate-200 flex flex-col shadow-xl z-10 h-full">
            {/* Header */}
